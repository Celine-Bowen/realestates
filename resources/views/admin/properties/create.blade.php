        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="body">
                    ...
                    <div class="form-group demo-checkbox">
                        @foreach($features as $feature)
                            <input type="checkbox" id="features-{{$feature->id}}" name="features[]" class="filled-in chk-col-pink" value="{{$feature->id}}" />
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <button type="submit" class="btn btn-pink btn-lg m-t-15 waves-effect">
