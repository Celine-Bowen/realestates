...
<section class="pink darken-2 white-text center">
    <div class="container">
        <div class="row m-b-0">
            <div class="col s12">
                    ...
                    <div class="searchbar">
                        ...
                        <div class="input-field col s12 m2">
                            <select name="type" class="browser-default">
                                ...
                                <option value="house">Cottage</option>
                        ...
                        <div class="input-field col s12 m2">
                            <select name="bedroom" class="browser-default">
                                ...
                                <option value="rent">one</option>
                                <option value="sale">Two</option>
                                <option value="sale">Three</option>
                                <option value="rent">Four</option>
                                <option value="sale">Five</option>
