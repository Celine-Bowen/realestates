<section class="carousel carousel-slider center">
    @if($sliders)
        ...
        @endforeach
    @else 
        <div class="carousel-item amber pink-text" style="background-image: url({{ asset('frontend/images/real_estate.jpg') }})" href="#1!">
            <h2>Slider Title goes here</h2>
            <p class="pink-text">Slider description goes here</p>
        </div>
    @endif
</section>