                ...
                @foreach($services as $service)
                    <div class="col s12 m4">
                        <div class="card-panel">
                            <i class="material-icons large pink-text">{{ $service->icon }}</i>
                            <h5>{{ $service->title }}</h5>
                        ...
                        <div class="card">
                            <div class="card-image">
                                ...
                                @if($property->featured == 1)
                                    <a class="btn-floating halfway-fab waves-effect waves-light pink" title="Featured"><i class="small material-icons">star</i></a>
                                @endif
                            </div>
